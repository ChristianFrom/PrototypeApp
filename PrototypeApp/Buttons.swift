...
//  PrototypeApp
//
//  Created by Christian From Rasmussen on 08/05/2020.
...
struct CircleButton: View {
    ...
    var body: some View {
        ...
        .background(
            ZStack {
                LinearGradient(
                    gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.7608050108, green: 0.8164883852, blue: 0.9259157777, alpha: 1) : #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)), Color(press ? #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1) :#colorLiteral(red: 0.8081197143, green: 0.8660972118, blue: 0.9849407077, alpha: 1))]), startPoint: .topLeading,
...
struct PayButton: View {
    ...
    var body: some View {
        ZStack {
            ...
            //Clipshape er en slags maske for billedet
            //Så med fingerprint-2 kan jeg lave en progress animation
            Image("fingerprint-2")
