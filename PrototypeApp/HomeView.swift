...
struct HomeView: View {
            ...
            HStack {
                HStack(spacing: 12.0) {
                    ...
                    VStack(alignment: .leading, spacing: 4.0) {
                        ...
                        Text("\(stepsTextNumber)/\(dailySteps) steps today").modifier(FontModifier(style: .caption))
    ...
    func startStepCountQuery(){
        ...
        let anchorDate = cal.date(bySettingHour: 6, minute: 0, second: 0, of: Date())
    ...
    struct HomeView_Previews: PreviewProvider {
        static var previews: some View {
            HomeView(showProfile: .constant(false), showContent: .constant(false), stepsTextNumber: 0)
        }
    }
